...
NGame = {
	...
	AGE_USHER_IN_TIME = 360,				-- how many months progress for a new age needs.
...
NDiplomacy = {
	...
	BUILD_SPY_DISCOVERED_PENALTY = -5.0,
	...
	JUSTIFY_TRADE_CONFLICT_COST = 5,
	INFILTRATE_ADMINISTRATION_COST = 25,
	SABOTAGE_REPUTATION_COST = 25,
	STEAL_MAPS_COST = 10,
	SUPPORT_REBELS_COST = 10,
	SOW_DISCONTENT_COST = 20,
	AGITATE_FOR_LIBERTY_COST = 20,
	SABOTAGE_RECRUITMENT_COST = 20,
	SLANDER_MERCHANTS_COST = 20,
	CORRUPT_OFFICIALS_COST = 10,
	INFILTRATE_ADMINISTRATION_DURATION = 60,  -- months
	...
	AGITATE_FOR_LIBERTY_DURATION = 60,  -- months
	SABOTAGE_RECRUITMENT_DURATION = 60,  -- months
	SLANDER_MERCHANTS_DURATION = 60, -- months
	...
	PO_DEMAND_PROVINCES_AE = 1.2, 				-- _DDEF_PO_DEMAND_PROVINCES_AE = 10, (Per development)
...
NCountry = {
	...
	BASE_TARIFF = 0.5,								-- Basic part of colonies income that goes to tariffs
...
NEconomy = {
	...
	COLONIST_TIME = 0.1,							-- _EDEF_COLONIST_TIME_
    -- WWU: increased to make colonists faster.
...
NMilitary = {
	...
	NAVAL_DOCTRINE_SAILORS_COST = 0.2,				-- Cost for switching naval doctrine (Share of sailors)
	NAVAL_DOCTRINE_MIN_FORCE_LIMIT = 10,			-- Minimum naval force limit to be able to select a naval doctrine
...
NAI = {
	...
	DIPLOMATIC_ACTION_FEDERATION_ACCEPTANCE_MULT = 1.0, -- AI scoring for alliance based on willingness to accept it if offered to them
...
NGraphics = {
	...
	CITY_SPRAWL_SHRINK_DISTANCE = 50.0, 			-- Start shrinking at this distance
...
NFrontend = {
	CAMERA_LOOKAT_X = 4263.0, 						-- Rotation point in main menu
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 1115.0,
	CAMERA_LOOKAT_SETTINGS_X = 4263.0, 				-- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,					-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 1115.0,
	CAMERA_START_X = 4263.0,						-- Initial position in main menu
	CAMERA_START_Y = 800,							-- Y is height
	CAMERA_START_Z = 1000.0,
	CAMERA_END_X = 4263.0,							-- Move to position in main menu
	CAMERA_END_Y = 900.0,
	CAMERA_END_Z = 1000.0,
	...
	FRONTEND_POS_X = 4263.0,
	FRONTEND_POS_Y = 900.0,
	FRONTEND_POS_Z = 1000.0,
	FRONTEND_LOOK_X = 4263.0,
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 1115.0,

	SETTINGS_POS_X = 4263.0,
	SETTINGS_POS_Y = 900.0,
	SETTINGS_POS_Z = 1000.0,
	SETTINGS_LOOK_X = 4263.0,
	SETTINGS_LOOK_Y = 0.0,
	SETTINGS_LOOK_Z = 1115.0,

	MP_OPTIONS_POS_X = 4263.0,
	MP_OPTIONS_POS_Y = 900.0,
	MP_OPTIONS_POS_Z = 1000.0,
	MP_OPTIONS_LOOK_X = 4263.0,
	MP_OPTIONS_LOOK_Y = 0.0,
	MP_OPTIONS_LOOK_Z = 1115.0,

	TUTORIAL_POS_X = 2894.0,
	TUTORIAL_POS_Y = 900.0,
	TUTORIAL_POS_Z = 1000.0,
	TUTORIAL_LOOK_X = 4263.0,
	TUTORIAL_LOOK_Y = 0.0,
	TUTORIAL_LOOK_Z = 1115.0,

	CONTENT_POS_X = 4263.0,
	CONTENT_POS_Y = 900.0,
	CONTENT_POS_Z = 1000.0,
	CONTENT_LOOK_X = 4263.0,
	CONTENT_LOOK_Y = 0.0,
	CONTENT_LOOK_Z = 1115.0,

	CREDITS_POS_X = 3077.0,
	CREDITS_POS_Y = 900.0,
	CREDITS_POS_Z = 1000.0,
	CREDITS_LOOK_X = 4263.0,
	CREDITS_LOOK_Y = 0.0,
	CREDITS_LOOK_Z = 1115.0,
},
...
NReligion = {
	...
	CHURCH_POWER_RATE_SCALE = 0.03,								-- Scaling value for rate at which church power is gained.
