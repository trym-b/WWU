...
NCountry = {
	...
	BASE_POWER_INCREASE = 1,						-- monthly base increase
	NAT_FOCUS_DECREASE = -1,							-- power taken away from non national focus power
	NAT_FOCUS_INCREASE = 1,							-- extra power given to national focus power
...
NAI = {
	...
	PEACE_TIME_MAX_MONTHS = 180, -- Max months applied to time factor in a war
	PEACE_TIME_EARLY_FACTOR = 0.3, -- During months of stubbornness the effect of time passed is multiplied by this
	...
	PEACE_WAR_EXHAUSTION_FACTOR = 1.25, -- AI willingness to peace based on war exhaustion
	PEACE_HIGH_WAR_EXHAUSTION_THRESHOLD = 8.0, -- Threshold for when PEACE_HIGH_WAR_EXHAUSTION_FACTOR is applied
	...
	PEACE_CAPITAL_FACTOR = 25, -- AI unwillingness to peace based on holding their own capital
	...
	PEACE_DESPERATION_FACTOR = 15, -- AI willingness to peace based on desperation from occupied homelands
	PEACE_ALLY_DESPERATION_MULT = 1.0, -- Multiplies PEACE_DESPERATION_FACTOR for allies in a war
	PEACE_REBELS_FACTOR = 35, -- AI willingness to peace based on number of revolts in their provinces
	...
	PEACE_TERMS_BASE_SCORE = 20, -- Base AI scoring for any peace demand
	PEACE_RANDOM_FACTOR = 0.75, -- How much randomness is applied to AI weighting (as a fraction of the goal score)
	PEACE_TERMS_CB_MULT = 2.5, -- AI desire for a wargoal is multiplied by this for having the right CB
	...
	PEACE_TERMS_MIN_SCORE = 1.5, -- AI "does not want" peace treaties that get a lower score than this (modified by ai personality)
	...
	PEACE_TERMS_PILLAGE_CAPITAL_MULT = 1.0,
	PEACE_TERMS_PROVINCE_BASE_MULT = 2.75,
	PEACE_TERMS_TRADE_POWER_BASE_MULT = 0.9,
	PEACE_TERMS_HUMILIATE_BASE_MULT = 0.9,
	...
	PEACE_TERMS_TRIBUTARY_BASE_MULT = 2.5, -- Multiplies with strategic interest of making them our Tributary
	...
	PEACE_TERMS_PROVINCE_NO_CB_MULT = 0.6, -- AI desire for a province is multiplied by this if it doesn't have a valid cb for it (only used when annexing, not applied to cores)
	PEACE_TERMS_PROVINCE_CORE_MULT = 3.0, -- AI desire for a province is multiplied by this if it has a core on it
	PEACE_TERMS_PROVINCE_WARGOAL_MULT = 3.0, -- AI desire for a province is multiplied by this if it is the wargoal
	PEACE_TERMS_PROVINCE_CLAIM_MULT = 2.5, -- AI desire for a province is multiplied by this if it has a claim on it
	PEACE_TERMS_PROVINCE_NOT_CULTURE_MULT = 0.85, -- AI desire for a province is multiplied by this if it is not the same culture
	...
	PEACE_TERMS_PROVINCE_OVEREXTENSION_MIN_MULT = 2.5, -- AI desire for a province is multiplied by this if it has 99% overextension (not applied to cores)
	PEACE_TERMS_PROVINCE_OVEREXTENSION_MAX_MULT = 0.9, -- AI desire for a province is multiplied by this if it has 0% overextension (not applied to cores)
	...
	PEACE_TERMS_PROVINCE_IMPORTANT_ALLY_MULT = 2.1, -- AI desire for giving provinces to allies that it has promised land
	...
	PEACE_TERMS_TRADE_POWER_VALUE_MAX = 1.75, -- Max AI desire for transfering trade power from shared node value
	...
	PEACE_TERMS_HUMILIATE_VALUE_MAX = 1.9, -- Max AI desire for humiliating its' enemy
	...
	PEACE_TERMS_RETURN_CORES_NOT_FRIEND_MULT = 0.0, -- AI desire for returning core provinces is multiplied by this if they are not friends of the country core is being returned to
	...
	PEACE_TERMS_RETURN_PROVINCE_STRATEGY_MULT = 0.25, -- If we have strategic priority on a province, AI desire to release it to another nation is multiplied by this amount
	...
	PEACE_TERMS_RELEASE_VASSAL_SAME_CULTURE_MULT = 0.55, -- AI desire for releasing a country is multiplied by this if they are the same culture group as releaser
	...
	PEACE_TERMS_RELEASE_ANNEXED_MAX_MULT = 1.25, -- Max AI desire mult for releasing countries
	...
	PEACE_TERMS_RELEASE_ANNEXED_SAME_CULTURE_MULT = 0.55, -- AI desire for releasing a country is multiplied by this if they are the same culture group as releaser
	...
	PEACE_TERMS_WAR_REPARATIONS_BASE_MULT = 0.125, -- AI desire for war reparations through peace
